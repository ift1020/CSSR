Namespace DealerDirect.CampaignManagement.Programs.CSSR.WelcomeNew
	Public Module WelcomeNew
		Public Const PROGRAM_ID As Integer = 201
	End Module
	...
	Public Class Program
        ...
        Public Overrides Property PreviewGeneratorControlPath As String = "~/App_Controls/cm/programs/cssr/PreviewGeneratorWelcomeNew.ascx"

        Public Sub New()
			MyBase.New(PROGRAM_ID)
		End Sub

		Public Shadows Function createPreview(ByVal language_code As String, ByVal channel_type_code As String, ByVal ptv As DealerDirect.CampaignManagement.Programs.VDP.PreviewTargetVersion, ByVal vehicle_code As String) As Programs.VDP.Preview
			...
			cmd.CommandText = "wsdp066_p201.createPreviewTreatment"
			...
			cmd.Parameters.Add(New Devart.Data.Oracle.OracleParameter("c_vehicle_cd", Devart.Data.Oracle.OracleDbType.VarChar)).Direction = System.Data.ParameterDirection.Input
			...
			cmd.Parameters("c_vehicle_cd").Value = vehicle_code
			cmd.ExecuteNonQuery()
