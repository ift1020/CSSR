Public Class cm_programs_cssr_targettingDefault
    ...
    'Public Program() As DealerDirect.CampaignManagement.Programs.AudienceProgram
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.tseMain.Program = Me.Program
        Me.tseMain.loadData(Not Me.IsPostBack)
    End Sub
